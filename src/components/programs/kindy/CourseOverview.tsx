...
const goals: string[] = [
  'Tạo nền tảng ngôn ngữ tự nhiên',
  'Giúp con hình thành phản xạ tiếng Anh',
  'Nuôi dưỡng sự tự tin, sự tò mò và tình yêu học tập',
];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="relative mx-auto w-full max-w-[440px]">
              ...
              >
                <img
                  ...
                  alt="Bé học tiếng Anh Mầm non tại ILE"
          ...
          <div className="order-2 lg:order-2">
            ...
            <h2 className="mt-5 font-heading text-3xl font-extrabold leading-[1.15] tracking-tight text-ink-900 sm:text-4xl">
              Sân chơi ngôn ngữ đầu đời của con
            </h2>

            <p className="mt-6 max-w-xl font-body text-base leading-relaxed text-ink-600 lg:text-lg">
              Ở ILE, chúng tôi tin rằng mỗi đứa trẻ đều có thể yêu tiếng Anh nếu
              được tiếp cận đúng cách - bằng sự dịu dàng, sự khuyến khích và rất
              nhiều niềm vui. Lớp học cho bé mầm non được thiết kế như một sân
              chơi ngôn ngữ, nơi con được hát, kể chuyện, vận động, khám phá và
              làm quen với tiếng Anh qua các hoạt động gần gũi với cuộc sống.
            </p>
